import {cardsPath, DraggableTypes, group} from "../Constants";
...
export function Card(props) {
    ...
    const className = `card-${props.index}${props.last ? " last " : ""}${isDragging ? " drag " : ""}${card.shown ? " shown " : ""}${group.includes(card.stack) || card.stack.includes("Store") ? " final " : ""}`
    return (
        <>
